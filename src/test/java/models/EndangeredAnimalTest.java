...
public class EndangeredAnimalTest {
    ...
    public void endangeredAnimal_instantiatesCorrectlyWithObjects_true() {
        EndangeredAnimal testEndangeredAnimal = new EndangeredAnimal("Eagle", 1, 4, "health", "young");
    ...
    public void equals_returnsTrueIfNameAndPersonIdAreSame_true() {
        EndangeredAnimal testEndangeredAnimal = new EndangeredAnimal("Bubbles", 1, 4, "health", "young");
        EndangeredAnimal anotherEndangeredAnimal = new EndangeredAnimal("Bubbles", 1, 4, "health", "young");
    ...
    public void all_returnsAllInstancesOfEndangeredAnimal_true() {
        EndangeredAnimal firstEndangeredAnimal = new EndangeredAnimal("Eagle", 1, 4, "health", "young");
        firstEndangeredAnimal.save();
        EndangeredAnimal secondEndangeredAnimal = new EndangeredAnimal("Lion", 3, 5, "health", "young");
    ...
    public void find_returnsEndangeredAnimalWithSameId_secondEndangeredAnimal() {
        EndangeredAnimal firstEndangeredAnimal = new EndangeredAnimal("Eagle", 1, 4, "health", "young");
        firstEndangeredAnimal.save();
        EndangeredAnimal secondEndangeredAnimal = new EndangeredAnimal("Lion", 1, 4, "health", "young");
        secondEndangeredAnimal.save();
